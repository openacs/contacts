...
<h3 class="contact-title"><if @hide_form_p;literal@ true><a href="./groups"></if>#contacts.Groups#<if @hide_form_p;literal@ true></a></if></h3>
</if>
<if @groups:rowcount@ gt 0>
<dl class="groups">
<multiple name="groups">
   <if @groups.sub_p;literal@ true><dd class="subgroup"></if><else><dt class="primarygroup"></else>
   ...
   <if @groups.sub_p;literal@ true></dd></if><else><dt></else>
</multiple>
<if @user_p;literal@ true><dt class="primarygroup">#contacts.Users#</dt></if>
</dl>
</if>
<else>
<if @hide_form_p;literal@ true><h3 class="contact-title"><a href="./groups">#contacts.Groups#</a></h3></if>
<if @user_p;literal@ true>
<dl class="groups">
...
<if @hide_form_p@ false and @delete_p;literal@ true>
