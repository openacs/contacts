<if @contacts_master_template@ eq /packages/contacts/lib/contacts-master>
  ...
  <div id="section">
    <ul>
    <multiple name="links">
      <li><a href="@links.url@" title="Go to @links.label@" id="@links.id@"><if @links.selected_p;literal@ true><strong></if>@links.label@<if @links.selected_p;literal@ true></strong></if></a><if @links:rowcount@ eq @links.rownum@><em>&nbsp;</em></if> </li>
    </multiple>
    </ul>
  </div>
</if>
