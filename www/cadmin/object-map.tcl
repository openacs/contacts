...
db_1row select_object_name { select acs_object__name(:object_id) as object_name }
...
db_multirow -extend { sort_order_key } -unclobber unmapped_attributes get_courses {
    select ca.attribute_id,
           ca.attribute,
           can.name,
           can.help_text,
