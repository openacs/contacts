...
# TODO. If Party_id = Organization, then we need to get a list of all
# possible people who can retrieve this message due to
# person-organization relationship.
# This could be on a new page that let's the user choose all the
# relationships on the first step and then click / hide the actual
# users.
